function P3DX = Ctrl_gau(P3DX,gains,g1,g2,g3,g4)
    ...
    if P3DX.pPos.rho > 0.003
        ...
        % Função exponencial...............................................                           
        Funcao = K^(-1)*(P3DX.pPos.Xd(7:8) + g1*tanh(g2*P3DX.pPos.Xtil(1:2)) + g3*exp(-P3DX.pPos.Xtil(1:2)*g4*P3DX.pPos.Xtil(1:2)')*P3DX.pPos.Xtil(1:2));
